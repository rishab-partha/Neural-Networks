...
class DibDump(object):
   #  BITMAPFILEHEADER  
   bmpFileHeader_bfType = None         # WORD
   bmpFileHeader_bfSize = None         # DWORD
   bmpFileHeader_bfReserved1 = None    # WORD
   bmpFileHeader_bfReserved2 = None    # WORD
   bmpFileHeader_bfOffBits = None      # DWORD
# BITMAPINFOHEADER
   bmpInfoHeader_biSize = None          # DWORD
   bmpInfoHeader_biWidth = None         # LONG
   bmpInfoHeader_biHeight = None        # LONG
   bmpInfoHeader_biPlanes = None        # WORD
   bmpInfoHeader_biBitCount = None      # WORD
   bmpInfoHeader_biCompression = None   # DWORD
   bmpInfoHeader_biSizeImage = None     # DWORD
   bmpInfoHeader_biXPelsPerMeter = None # LONG
   bmpInfoHeader_biYPelsPerMeter = None # LONG
   bmpInfoHeader_biClrUsed = None       # DWORD
   bmpInfoHeader_biClrImportant = None  # DWORD
# The true color pels
   imageArray = None
