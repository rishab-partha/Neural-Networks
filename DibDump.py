 ...
 *'''
         ...
         dibdumper.imageArray = np.zeros((dibdumper.bmpInfoHeader_biHeight, dibdumper.bmpInfoHeader_biWidth), np.int32) # Create the array for the pels
'''*
 ...
 *'''
         if dibdumper.bmpInfoHeader_biBitCount == 1: # each bit is a color, so there are 8 pels per byte.  Works
            ...
            *'''
            ...
            for row in range(bmpInfoHeader_biHeight): # read over the rows
               if topDownDIB:
                  i = row 
               else:
