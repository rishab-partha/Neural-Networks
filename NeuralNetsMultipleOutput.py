...
class NeuralNet:
   ...
   def calculateDeltas(self, inputIndex):
      ...
      for i in range(self.layerSizes[2]):
         ...
         outputDeriv = self.activations[2][i]*(1 - self.activations[2][i])
...
def main(configFile): 
   ...
   randomRange = [float(val) for val in filehyperParams.readline().split()][0]             #End of reading hyperparameters
